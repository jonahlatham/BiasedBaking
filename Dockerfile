...
RUN dotnet restore "./biasedBaking.csproj"

# Compile, then pack the compiled app and dependencies into a deployable unit.
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-publish?tabs=netcore21
RUN dotnet publish "biasedBaking.csproj" -c Release -o /app/publish
...
# To run the app, run `dotnet biasedBaking.dll`, which we just copied over.
# ENTRYPOINT ["dotnet", "biasedBaking.dll"]
CMD ASPNETCORE_URLS=http://*:$PORT dotnet biasedBaking.dll